...
3. Значение в поле Length (Длина) – это длина чего?
   - Всего пакета (payload + 8 байтов заголовка)
...
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   ...
   - Они совпадают (у моего с 33086 на 53, у ответного с 53 на 33086)


<img src="images/wireshark.png" width=700 />
...
#### Скрины
<img src="images/filezilla1.jpg" width=700 />
<img src="images/filezilla2.jpg" width=700 />
<img src="images/filezilla3.jpg" width=700 />
<img src="images/filezilla4.jpg" width=700 />
<img src="images/filezilla5.jpg" width=700 />
