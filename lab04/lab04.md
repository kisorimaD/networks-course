...
6. Посмотрите на последующий TCP-пакет с флагом SYN, отправленный вашим компьютером.
   ...
   - Последний да, а первый соответствует адресу из ответа на запрос по хосту google-ohttp-relay-safebrowsing.fastly-edge.com
...
![](images/wireshark_spbu_typeNS.png)
...
![](images/wireshark_spbu_nspu.png)
...
1. Что такое база данных whois?
   - whois - это общедоступный, распределенный сервис, содержащий информацию о зарегистрированных доменных именах, IP-адресах и владельцах сайтов. Она используется для проверки занятости доменов, поиска контактов администраторов, определения регистратора, даты создания и окончания срока регистрации домена.
2. Используя различные сервисы whois в Интернете, получите имена любых двух DNS-серверов. 
   ...
   - who.is
   - ![](images/whois_youtube.png)
   - ![](images/whois_ifconfigme.png)
